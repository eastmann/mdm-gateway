...
<!--                                               :value="checkListFinance.companyStatusCode"/>-->
...
<!--                            </tr>-->
                            ...
                            <tr>
                                ...
                                <td> {{this.$parent.getRisk(stopFactors[12].risk)}}</td>
                            </tr>
                        </table>
                    </BlockInfo>
...
<!--                        </tr>-->
                    ...
                    <div class="margin-top-10">
                        <p>Комментарий:</p>
                        <pre class="pre-info">{{checkListFinance.comment}}</pre>
                    </div>

                    <TextEdit :value="checkListFinance.userFio" caption="ФИО сотрудника:" placeholder="" size="60px"/>
                ...
                <div class="html2pdf__page-break"/>
                <section class="pdf-item">
                    <BlockInfo caption="МОДУЛЬ ПО ЗАКУПКАМ" v-if="checkListFinance && this.$parent.showPurchaseModule">
