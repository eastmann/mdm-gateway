<template>
    <div>
        <div class="card-header-inn">
            Массовая проверка контрагентов для НД
        </div>
        ...
        <div>
            ...
            <div class="margin-top-30">
                <div class="rtk-button-save" v-on:click="exportCheckListCounterpartyInnToExel">
...
<script>
    ...
    export default {
        name: "CheckListCounterPartyReport",
        data() {
            return {
                inputInn: "",
                loadJournalMessage: "",
        ...
        methods: {
            ...
            exportCheckListCounterpartyInnToExel() {
                this.loadJournalMessage = "Загрузка данных отчета...";
                var file = 'CheckListCounterpartyInnReport.xlsx';
                axios({
                    method: 'post',
                    url: urls.exportCheckListCounterpartyInnReportToExcel(),
