<template>
    <div class="page">
        <div class="margin-left-5 check-list">
            <CheckListForSalesToPdf ref="toPdf" v-if="checkListForSales"
                                    :check-list-for-sales="checkListForSales"
                                    :spark-organization-info="sparkOrganizationInfo"
                                    :fin-indicators="finIndicators"
                                    :stop-factors="stopFactors"/>

            <div class="rtk-button-port" v-if="checkListForSales" v-on:click="onButtonPdfClick()">Печать в PDF</div>

            <!--            <div class="rtk-button-port" v-if="checkListForSales" v-on:click="onButtonSaveClick()">Сохранить</div>-->
            <div class="rtk-button-port" v-if="checkListForSales" v-on:click="goHome">Отмена</div>
        ...
        <div class="check-list">
            ...
            <modal-window ref="modal">
                ...
                <template v-slot:body>
                    <div>
                        <div v-if="checkListForSales.checkDate === null">
                ...
                <table class="table-border-none">
                    <tr>
                        <td>
                            ...
                            <!--                            <TextField caption="Статус организации:" :value="checkListForSales.companyStatusCode"/>-->
            ...
            <BlockInfo caption="ОЦЕНКА КОМПАНИИ КЛИЕНТА"
                ...
                <DropDownTableRow v-bind:editable="false" v-bind:caption="getFullNameByDictiName('COMPANY_LIQUIDATED')"
                                  factor="STOP"
                                  v-model="checkListForSales.checkListParam[getIdByDictiName('COMPANY_LIQUIDATED')].checked"/>

                <DropDownTableRow v-bind:editable="false"
                                  v-bind:caption="getFullNameByDictiName('CHL_PAR_BANKRUPT_INFO')"
                                  factor="NONE"
                                  v-model="checkListForSales.checkListParam[getIdByDictiName('CHL_PAR_BANKRUPT_INFO')].checked"/>

                <DropDownTableRow v-bind:editable="false"
                                  v-bind:caption="getFullNameByDictiName('SIX_MONTH_LESS_BUSIN')"
                                  factor="NONE"
                                  v-model="checkListForSales.checkListParam[getIdByDictiName('SIX_MONTH_LESS_BUSIN')].checked"/>

                <DropDownTableRow v-bind:editable="false" v-bind:caption="getFullNameByDictiName('CHL_PAR_TAX_ARREARS')"
                                  factor="INFO"
                                  v-model="checkListForSales.checkListParam[getIdByDictiName('CHL_PAR_TAX_ARREARS')].checked"/>

                <DropDownTableRow v-bind:editable="false"
                                  v-bind:caption="getFullNameByDictiName('CHL_PAR_ACCOUNT_FROZEN')"
                                  factor="INFO"
                                  v-model="checkListForSales.checkListParam[getIdByDictiName('CHL_PAR_ACCOUNT_FROZEN')].checked"/>

                <DropDownTableRow v-bind:editable="false" v-bind:caption="getFullNameByDictiName('CHIEF_DISQUALIFIED')"
                                  factor="INFO"
                                  v-model="checkListForSales.checkListParam[getIdByDictiName('CHIEF_DISQUALIFIED')].checked"/>

                <DropDownTableRow v-bind:editable="false" v-bind:caption="getFullNameByDictiName('WRONG_COMPANY_INFO')"
                                  factor="INFO"
                                  v-model="checkListForSales.checkListParam[getIdByDictiName('WRONG_COMPANY_INFO')].checked"/>
            </BlockInfo>
            ...
            <BlockInfo caption="СТОП-ФАКТОРЫ" v-if="checkListForSales">
                ...
                <table class="fin-table">
                    ...
                    <tr>
                        ...
                        <td> {{less10days(stopFactors[7].value)}}</td>
                        <td> {{getRisk(calcTurnoverStock)}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> {{stopFactors[10].value !== '0' ? stopFactors[10].value : '-'}}</td>
            ...
            <BlockInfo caption="ИТОГИ ПО РАСЧЕТАМ" v-if="checkListForSales">
                ...
                <table class="margin-top-10">
                    <tr>
                        ...
                        <td :class="cssRecomendation">
                            {{recomendationText( round(calcResultRisk, 0) ) }}
                        </td>
                    </tr>
                </table>
<!--                <div class="container">-->
<!--                    <div class="container-left"> Рекомендация :</div>-->
<!--                    <div class="container-right">-->
<!--                        <div :class="cssRecomendation">-->
<!--                            екст {{round(calcResultRisk, 0)}}-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
            ...
            <BlockInfo caption="ИНФОРМАЦИЯ" v-if="checkListForSales">
                ...
                <div class="margin-top-10">
                    <p>Комментарий:</p>
                    <textarea class="comment-info" v-model="checkListForSales.comment"></textarea>
                </div>

                <TextEdit v-model="checkListForSales.userFio" caption="ФИО сотрудника:" placeholder="" size="60px"/>

                Дата: <input class="margin-top-10" v-model="checkDate" type="date">

<!--                <div class="margin-top-10">-->
<!--                    <div class="rtk-button-port " v-if="checkListForSales" v-on:click="goPurchaseModule">-->
<!--                        {{showPurchaseModule ?-->
...
<!--            <BlockInfo caption="МОДУЛЬ ПО ЗАКУПКАМ" v-if="checkListForSales && showPurchaseModule">-->
...
<!--                &lt;!&ndash;                <div class="font-color-violet margin-top-10">&ndash;&gt;-->
<!--                &lt;!&ndash;&lt;!&ndash;                    <img src="@/assets/img/check_list/info.png" class="icon-info">&ndash;&gt;&ndash;&gt;-->
<!--                &lt;!&ndash;                    ИТОГИ ПО РАСЧЕТАМ&ndash;&gt;-->
<!--                &lt;!&ndash;                </div>&ndash;&gt;-->
...
<!--                            </div>-->
<!--                        </td>-->
<!--                        <td :class="cssContractRecomended">-->
<!--                            {{yesNoRecomendation(purchasingModule.contractRecomended)}}-->
<!--                        </td>-->
<!--                    </tr>-->
<!--                    <tr>-->
<!--                        <td>-->
...
<!--                            </div>-->
<!--                        </td>-->
<!--                        <td :class="cssPrePaymentRecomended">-->
<!--                            {{yesNoRecomendation(purchasingModule.prePaymentRecomended)}}-->
<!--                        </td>-->
<!--                    </tr>-->
<!--                </table>-->
<!--            </BlockInfo>-->
...
<script>
    ...
    import CheckListForSalesToPdf from "@/views/search/checkListForSales/components/CheckListForSalesToPdf";
    import DropDownTableRow from "@/components/checkList/DropDownTableRow";
    import checkListUtils from "@/js/utils/checkList";

    export default {
        name: "CheckListForSales",
        components: {
            DropDownTableRow,
            CheckListForSalesToPdf,
            // DropDown,
            BusinessSearchBox,
            ModalWindow,
            TextField,
        ...
        computed: {
            ...
            calcTurnoverStock() {
                let risk = -1;
                //if (this.checkListForSales.mainCompanyActivityIsServices === 'YES'){
            ...
            cssRecomendation: function () {
                return {
                    active: true,
                    'recomendation-red': this.calcResultRisk <= 0,
                    'recomendation-yellow': this.calcResultRisk > 0 && this.calcResultRisk < 3,
                    'recomendation-green': this.calcResultRisk >= 3
                }
            },
            ...
            calcRatingForIndicators() {
                // if (this.checkListForSales.mainCompanyActivityIsServices === null){
                //     return 0;
                // }
                let isMain = true;//this.yesNoRus(this.checkListForSales.mainCompanyActivityIsServices) === 'Да';
                let cRating = 0;
        ...
        methods: {
            ...
            setTurnoverStockEmpty() {
                this.stopFactors[7].risk = -1;
            },

            restoreTurnoverStockEmpty() {
                this.stopFactors[7].risk = this.turnoverStock;
            },
            ...
            loadBusinessData() {
                if (this.$route.params.inn != null) {
                    this.loadCheckListForSalesByInn(this.$route.params.inn)
                } else {
                    this.clearView();
                }
            },
            ...
            loadCheckListForSalesByInn(inn) {
                let url = urls.checkListForSalesByInnUrl(inn);
                this.loadAndShowCheckListForSalesByUrl(url, inn);
            },

            loadAndShowCheckListForSalesByUrl(url, inn) {
                this.checkListForSales = null;
                let component = this;
                axios.get(url)
                    .then(function (response) {
                        component.checkListForSales = response.data.checkListForSalesDto.checkListForSales;
                        component.sparkOrganizationInfo = response.data.checkListForSalesDto.organizationInfo;
                        component.stopFactors = response.data.checkListForSalesDto.financeInfo.stopFactors;
                        component.turnoverStock = -1;//component.stopFactors[8].risk;
                        component.finIndicators = response.data.checkListForSalesDto.financeInfo.finIndicators;
                        component.purchasingModule = response.data.checkListForSalesDto.financeInfo.purchasingModule;
                        component.checkDate = dateUtils.timeStampToDate(component.checkListForSales.checkDate);
                    })
                    .catch(function (e) {
                    });
            },
            ...
            loadCheckListBySuggestion(suggestion) {
                ...
                if (suggestion.data != null && suggestion.data.inn != null) {
                    ...
                    if (this.$route.params.inn !== inn) {
                        this.$router.push(paths.checkListForSalesByInn(inn))
                        this.loadCheckListForSalesByInn(inn);
                    }
                }
            },

            onSave() {
                let url = urls.postCheckListForSalesUrl();

                if ((this.checkDate != null) && (this.checkDate !== "")) {
                    this.checkListForSales.checkDate = new Date(this.checkDate).getTime();
                } else
                    this.checkListForSales.checkDate = new Date().getTime();

                this.checkListForSales.inn = this.inn;
                axios.post(url, this.checkListForSales)
                    .then((response) => {
            ...
            getIdByDictiName(dictiName) {
                return checkListUtils.getIdByDictiName(this.checkListForSales, dictiName)
            },

            getFullNameByDictiName(dictiName) {
                return checkListUtils.getFullNameByDictiName(this.checkListForSales, dictiName)
            },
            ...
            personalCount() {
                return this.checkListForSales.personalCount !== 0 ? this.checkListForSales.personalCount : 'нет данных';
            },
            ...
            recomendationText(risk){
                if (risk <= 0) {
                    return "Заключение договора не рекомендовано"
                } else if ((risk > 0) && (risk < 3)){
                    return "Заключение договора на условиях отсрочки не рекомендовано";
                } else if (risk >= 3){
                    return "Рекомендовано заключение договора на любых условиях оплаты"
                }
                return "-";
            }
        },
